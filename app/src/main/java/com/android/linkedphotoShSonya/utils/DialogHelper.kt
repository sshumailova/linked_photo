...
import com.android.linkedphotoShSonya.Adapter.SelectCountryAdapter
import com.android.linkedphotoShSonya.R
import android.widget.SearchView.OnQueryTextListener as OnQueryTextListener1

object DialogHelper {
    fun showDialog(context: Context, list: ArrayList<String>) {
        ...
        val adapter = SelectCountryAdapter(dialog)
